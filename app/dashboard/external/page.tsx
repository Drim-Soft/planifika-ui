            ...
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 animate-pulse transition-colors">
                <div className="flex items-center">
                  <div className="p-2 bg-gray-200 dark:bg-gray-700 rounded-lg transition-colors">
                    <div className="w-8 h-8"></div>
                  </div>
                  <div className="ml-4 flex-1">
                    <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-24 mb-2 transition-colors"></div>
                    <div className="h-8 bg-gray-200 dark:bg-gray-700 rounded w-16 transition-colors"></div>
                  </div>
                </div>
              </div>
            ))}
                ...
                {isLoadingAllProjects ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {Array.from({ length: 6 }).map((_, i) => (
                      <div key={i} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 animate-pulse transition-colors">
                        ...
                        <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-full mb-2 transition-colors"></div>
                        <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-5/6 mb-4 transition-colors"></div>
                        <div className="h-2 bg-gray-200 dark:bg-gray-700 rounded-full w-full mb-4 transition-colors"></div>
                        <div className="h-10 bg-gray-200 dark:bg-gray-700 rounded w-full transition-colors"></div>
                      </div>
                    ))}
                  </div>
                ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 animate-pulse transition-colors">
                  ...
                  <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-1/2 mb-4 transition-colors"></div>
                  <div className="flex gap-2">
                    <div className="h-10 bg-gray-200 dark:bg-gray-700 rounded flex-1 transition-colors"></div>
                    <div className="h-10 bg-gray-200 dark:bg-gray-700 rounded w-20 transition-colors"></div>
                  </div>
                </div>
              ))}
            </div>
